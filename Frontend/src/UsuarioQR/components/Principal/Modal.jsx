...
export default function Modal({ onClose, onRegister }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="fixed inset-0 flex items-center justify-center bg-[#000c] bg-opacity-50 p-4" onClick={onClose}></div>
            
            {/* Modal - detiene propagación de eventos */}
            <div 
                className="bg-white rounded-xl shadow-2xl p-6 z-10 w-[350px] relative"
