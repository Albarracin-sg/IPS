...
const RegisterForm = () => {
  return (
    <div className="bg-gradient-to-br from-white to-blue-50 shadow-xl rounded-3xl p-8 w-full max-w-md mx-auto flex justify-center items-center flex-col backdrop-blur-lg border border-gray-100">
      {/* Header with curved design */}
      <div className="mb-8 text-center">
        <div className="relative">
          <h2 className="text-2xl font-bold text-gray-800 mb-2">FORMULARIO DE REGISTRO</h2>
          <div className="h-1 w-32 bg-gradient-to-r from-emerald-400 to-blue-500 rounded-full mx-auto"></div>
        </div>
      </div>

      <form className="w-full space-y-5">
        {/* Nombre fields with curved styling */}
        ...
        {/* Submit button with gradient and curved design */}
        <button
          type="submit"
          className="w-full py-3 px-4 bg-gradient-to-r from-emerald-400 to-blue-500 text-white font-medium rounded-full hover:opacity-90 transition-opacity focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 shadow-lg"
        >
          ENVIAR
        </button>
      </form>
