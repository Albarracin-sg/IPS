...
const RegisterForm = () => {
  return (
    // Contenedor principal con diseño responsive y espacio suficiente para el logo
    <div className="bg-gradient-to-br from-white to-blue-50 shadow-xl rounded-3xl p-6 w-full max-w-6xl mx-auto border border-gray-100 mt-16">
      ...
      <form className="w-full flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-1/2 space-y-4">
          <h3 className="text-lg font-semibold text-gray-700 border-b border-gray-200 pb-2">Datos Personales</h3>
        ...
        <div className="w-full md:w-1/2 space-y-4">
          <h3 className="text-lg font-semibold text-gray-700 border-b border-gray-200 pb-2">Información de Contacto e Identificación</h3>
