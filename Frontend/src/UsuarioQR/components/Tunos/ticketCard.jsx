  ...
  return (
    <div className="flex justify-center items-center p-4">
      <div className="bg-white rounded-3xl shadow-lg w-full max-w-md md:max-w-4xl overflow-hidden border border-blue-100">
        {/* Desktop layout (horizontal) - INCREASED HEIGHT */}
        <div className="hidden md:flex flex-row w-full">
          {/* Left side - Header */}
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 px-6 py-16 rounded-r-3xl w-1/3 flex flex-col justify-center">
            ...
            <p className="text-center text-sm text-gray-600 mt-4">¡Gracias por tu paciencia!</p>
          </div>
          ...
          <div className="flex-1 p-8">
            <div className="flex justify-between items-center h-full">
              ...
              {/* Ticket Number */}
              <div className="text-center bg-gradient-to-r from-teal-400 to-blue-500 p-6 rounded-xl w-40 shadow-md transform transition-transform hover:scale-105">
            ...
            {/* Footer */}
            <div className="text-center py-4 px-2 mt-12 bg-blue-50 rounded-xl">
        ...
        {/* Mobile layout (vertical - KEEPING ORIGINAL PROPORTIONS) */}
        <div className="md:hidden">
          ...
          {/* Content container with softer spacing - ORIGINAL MOBILE DESIGN */}
          <div className="p-6">
            {/* Ticket content */}
            <div className="flex flex-col items-center justify-center space-y-8 py-6">
              ...
              <div className="text-center bg-gradient-to-r from-teal-400 to-blue-500 p-4 rounded-xl w-40 shadow-md ">
                <p className="text-xs text-white mb-1">NÚMERO</p>
                <h1 className="text-5xl font-bold text-white">
                  {currentPatient.turn}
                </h1>
