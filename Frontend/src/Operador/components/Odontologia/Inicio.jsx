...
export default function Inicio() {
    ...
    return (
        ...
        <div className="min-h-screen w-full flex items-center justify-center py-8 px-4">
            <div className="bg-gradient-to-br from-white to-blue-50 shadow-xl rounded-3xl p-4 sm:p-6 w-full max-w-6xl mx-auto border border-gray-100">
                ...
                {/* Barra de búsqueda estilizada - responsive */}
                <div className="mb-6 flex flex-col sm:flex-row gap-3 items-center">
                    <div className="relative w-full sm:w-1/4">
                        <select 
                            className="w-full px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-full focus:outline-none focus:border-blue-500 transition-all text-gray-700 appearance-none"
                    ...
                    <div className="relative w-full sm:w-2/4">
                        <input
                            ...
                            className="w-full px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-full focus:outline-none focus:border-blue-500 transition-all text-gray-700"
                        />
                        {/* Ícono de búsqueda */}
                        <div className="absolute right-4 top-3 text-gray-400">
                            <svg
                ...
                {/* Formulario dividido en dos secciones - responsive */}
